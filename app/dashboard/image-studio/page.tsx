...
import { Plus, ChevronDown, Sparkles, Image as ImageIcon } from "lucide-react";
...
export default function ImageStudioPage() {
  ...
  const handleGenerate = () => {
    ...
    console.log("Generating:", { prompt, aspectRatio, count, model });
  };
    ...
    <div className="flex h-full flex-col bg-white text-stone-950 px-4 py-10 font-sans overflow-y-auto">
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="bg-white border border-stone-200 rounded-3xl shadow-sm p-4 sm:p-6">
          ...
          {/* Controls Bar (Aspect Ratio, Count, Model Selector, Generate Button) */}
